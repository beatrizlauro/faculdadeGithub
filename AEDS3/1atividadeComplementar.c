...
int main(int argc, char *argv[]) {
    //chamado pelo comando ./programa -h no prompt:
...
void printHelp() {
    ...
    printf("1) Função para calcular o valor de n!. Fatorial é o produto de todos os inteiros positivos menores ou iguais a n.\n");
    printf("2) Função para calcular o número harmônico designado por Hn e definido como o enésimo termo da série harmônica. \n");
    printf("3) Função para calcular e escrever o valor de S\n");
    printf("4) Função para calcular que leia um valor inteiro e positivo N, calcule o mostre o valor de E, conforme a fórmula pré definida.\n");
    printf("5) Função para calcular a raiz quadrada de x.\n");
    printf("6) Função para calcular cosseno pelo polinômio de Mclaurin.\n");
    printf("7) Função para calcular o seno da série pré definida\n");
}